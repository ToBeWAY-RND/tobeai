    ...
    >
      ...
      <div class="w-full flex justify-between items-end">
        ...
        <SendButton
          ...
          type="button"
          isDisabled={props.disabled || isSendButtonDisabled()}
          class={`m-0 ${props.isFullPage ? 'h-14' : 'h-[50px]'} flex items-center justify-center ${(props.isFullPage && props.uploadsConfig?.isSpeechToTextEnabled) ? 'pl-1.5 pr-4': 'pl-3 pr-4'}`}
